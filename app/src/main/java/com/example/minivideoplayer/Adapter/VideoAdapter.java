package com.example.minivideoplayer.Adapter;
...
import com.example.minivideoplayer.R;
import com.example.minivideoplayer.VideoActivity;
...
public class VideoAdapter extends RecyclerView.Adapter<VideoHolder> {
    ...
    public VideoHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View mview = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.video_cardview,viewGroup,false);
